...
ui <-shiny::navbarPage("PISA-Based Test for Schools Validation Study",
              ...
              shiny::tabPanel("Introduction",
                        shiny::HTML('<b> PISA-Based Test for Schools (PBTS) Validation study report </b> </br>  </br> <b> Overview </b>  <p> The main purpose of the validation study
                      ...
                      The report is organised in three sections:  </br> 
                        ...
                        shiny::HTML('</br> <b> Control room </b> '),
